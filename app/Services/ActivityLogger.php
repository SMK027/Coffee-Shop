...
class ActivityLogger
{
    ...
    private static array $routeLabels = [
        ...
        'login.security-key'                 => 'Ouverture de la connexion par clé de sécurité',
        'login.security-key.options'         => 'Défi de connexion par clé de sécurité',
        'login.security-key.store'           => 'Connexion par clé de sécurité',
        'supervisor-security-key.options'    => 'Défi d\'approbation superviseur par clé de sécurité',
        'logout'                             => 'Déconnexion',
        ...
        'employee.internal-notes.index'          => 'Consultation de la messagerie interne',
        'employee.internal-notes.create'         => 'Ouverture de l’éditeur de note interne',
        'employee.internal-notes.store'          => 'Envoi d’une note interne',
        'employee.internal-notes.edit'           => 'Ouverture de la modification d’une note interne',
        'employee.internal-notes.update'         => 'Modification d’une note interne',
        'employee.internal-notes.destroy'        => 'Suppression d’une note interne',
        'employee.internal-notes.attachments.download' => 'Téléchargement d’une pièce jointe de note interne',
        'employee.lost-credentials.create'         => 'Ouverture du signalement d’identifiants perdus',
        'employee.lost-credentials.store'          => 'Signalement d’identifiants perdus',
        ...
        'employee.profile.security-keys.options' => 'Défi d\'enregistrement d\'une clé de sécurité',
        'employee.profile.security-keys.store'   => 'Enregistrement d\'une clé de sécurité',
        'employee.profile.security-keys.destroy' => 'Suppression d\'une clé de sécurité',
        ...
        'employee.users.quick-login.reactivate' => 'Réactivation de la connexion rapide',
        'employee.users.take-control'        => 'Prise de contrôle d’un compte salarié',
        'employee.users.release-control'     => 'Retour au compte d’origine après prise de contrôle',
        ...
        'employee.supervisors.security-keys.options' => "Défi d'enregistrement d'une clé de sécurité superviseur",
        'employee.supervisors.security-keys.store'   => "Enregistrement d'une clé de sécurité superviseur",
        'employee.supervisors.security-keys.destroy' => "Suppression d'une clé de sécurité superviseur",
        // Paramètres boutique
