...
<head>
    ...
    <title>Réinitialisation du code PIN</title>
    <style>
        ...
        .card-number { font-family:monospace; font-size:15px; color:#92400e; font-weight:600; }
...
<div class="wrap">
    <div class="card">
        <div class="header">
            <h1>☕ Coffee Shop — Carte de fidélité</h1>
            <p>Réinitialisation du code PIN</p>
        </div>
        <div class="body">
            <p>Bonjour <strong>{{ $card->full_name }}</strong>,</p>
            <p>
                Un super administrateur a déclenché la réinitialisation du code PIN de votre
                carte de fidélité <span class="card-number">{{ chunk_split($card->card_number, 4, ' ') }}</span>.
                Cliquez sur le bouton ci-dessous pour définir un nouveau code PIN.
            </p>

            <div class="btn-wrap">
                <a href="{{ $resetUrl }}" class="btn">Définir mon nouveau code PIN</a>
            </div>
            ...
            <div class="warning">
                ...
                demandez à un membre de l'équipe de vous en envoyer un nouveau.
            </div>
        </div>
        <div class="footer">
            <p>Si vous n'attendiez pas cet e-mail, ignorez-le. Votre code PIN reste inchangé.</p>
        </div>
    </div>
</div>
</body>
