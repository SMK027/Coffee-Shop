<x-employee-layout title="Cartes de fidélité">
    <x-slot name="headerActions">
        <div class="flex items-center gap-3">
            <a href="{{ route('employee.loyalty.create') }}"
               class="bg-amber-700 hover:bg-amber-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-1.5">
