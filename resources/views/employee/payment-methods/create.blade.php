<x-employee-layout title="Nouveau moyen de paiement">
    <x-slot name="headerActions">
        <a href="{{ route('employee.payment-methods.index') }}" class="text-stone-500 hover:text-stone-700 text-sm">← Retour</a>
    </x-slot>

    <form action="{{ route('employee.payment-methods.store') }}" method="POST" class="max-w-xl space-y-5">
        @csrf
        ...
        <div class="bg-white rounded-xl shadow-sm border border-stone-100 p-5 space-y-4">
            ...
            <div>
                ...
                <p class="text-xs text-stone-500 mt-1">Identifiant unique, minuscules et tirets uniquement.</p>
