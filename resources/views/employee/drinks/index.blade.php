        ...
        @else
            <div class="divide-y divide-stone-50">
                ...
                <div class="px-6 py-4 flex items-center gap-4">
                    ...
                    <div class="font-semibold text-stone-700 text-sm flex-shrink-0">
                    ...
                    <div class="flex items-center gap-2 flex-shrink-0">
                        <form action="{{ route('employee.drinks.toggle', $drink) }}" method="POST">
                            ...
                            <button type="submit" title="{{ $drink->available ? 'Rendre indisponible' : 'Rendre disponible' }}"
                                    class="p-1.5 rounded-lg transition-colors {{ $drink->available ? 'text-green-600 hover:bg-green-50' : 'text-stone-400 hover:bg-stone-100' }}">
                        ...
                        <a href="{{ route('employee.drinks.edit', $drink) }}" class="p-1.5 text-amber-600 hover:bg-amber-50 rounded-lg transition-colors" title="Modifier">
                        ...
                        <form action="{{ route('employee.drinks.destroy', $drink) }}" method="POST"
                            ...
                            @csrf @method('DELETE')
                            <button type="submit" class="p-1.5 text-red-400 hover:bg-red-50 rounded-lg transition-colors" title="Supprimer">
