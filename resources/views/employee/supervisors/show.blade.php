<x-employee-layout title="Détails du superviseur" subtitle="{{ $supervisor->supervisor_number }}">
    ...
    <div class="max-w-2xl bg-white border border-stone-200 rounded-xl p-5 shadow-sm space-y-5">
        <div>
            ...
            <p class="text-sm text-stone-500 mt-1">Utilisez ce code-barres pour un bypass superviseur depuis l'application mobile.</p>
        </div>
        ...
        <div class="border border-stone-200 rounded-lg p-4 bg-stone-50">
            <p class="text-sm text-stone-600 mb-3">Code-barres de bypass superviseur</p>
    ...
    <script>
        ...
        JsBarcode('#supervisor-barcode', value, {
            format: 'CODE128',
            lineColor: '#1f2937',
            width: 1.6,
            height: 80,
