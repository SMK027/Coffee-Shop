<x-employee-layout title="Commandes">
    <x-slot name="headerActions">
        <a href="{{ route('employee.orders.identify') }}" class="bg-amber-700 hover:bg-amber-600 text-white px-3 sm:px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-1.5 sm:gap-2">
