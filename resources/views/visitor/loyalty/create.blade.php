    ...
    <section class="py-12">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-stone-100 p-6 sm:p-8">
                ...
                <form id="loyalty-create-form" action="{{ route('loyalty.store') }}" method="POST" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        @include('partials.recaptcha-v3', ['formId' => 'loyalty-create-form', 'action' => 'loyalty_create_form'])
